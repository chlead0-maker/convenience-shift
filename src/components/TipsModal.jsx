...
const TIPS = [
  {
    q: "❓ 5인 이상이면 야간수당 안 줘도 되나요?",
    a: [
      "반대예요! 직원이 5명 이상(상시근로자 5인 이상)인 가게는 야간수당을 꼭 줘야 합니다.",
      "• 5인 이상 → 야간(밤 22시~새벽 6시)·연장·휴일 근무에 50% 가산수당 의무",
      "• 5인 미만 → 이 가산수당은 법적 의무가 아님 (안 줘도 됨, 단 최저임금·주휴수당은 인원과 무관하게 적용)",
      "그래서 이 앱은 직원마다 '야간수당 지급'을 켜고 끌 수 있게 했어요. 5인 미만이면 꺼두시면 됩니다.",
    ],
  },
  {
    q: "💰 최저임금은 얼마인가요?",
    a: [
      "최저임금은 매년 1월에 바뀝니다. (2025년 기준 시급 10,030원)",
      "최신 금액은 인터넷에 '올해 최저임금'으로 검색하거나 고용노동부(☎1350)에서 확인하세요.",
  ...
  },
  {
    ...
    a: [
      ...
      "계산: (1주 근무시간 ÷ 40) × 8 × 시급",
      "예) 주 30시간·시급 10,000원 → (30÷40)×8×10,000 = 60,000원 추가",
  ...
  },
  {
    ...
    a: [
      ...
      "예) 시급 10,000원으로 22시~06시(8시간) → 기본 80,000 + 야간가산 40,000 = 120,000원",
